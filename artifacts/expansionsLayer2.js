export const expansionsLayer2Abi = [
  {
    inputs: [
      ...
      { internalType: 'address', name: '_gasCalculator', type: 'address' }
    ],
  ...
  },
  {
    ...
    name: 'gasETHContract',
    outputs: [
      { internalType: 'contract gasCalculator', name: '', type: 'address' }
    ],
    stateMutability: 'view',
    type: 'function'
  },
  ...
  {
    inputs: [
      { internalType: 'address', name: 'newGasCalculator', type: 'address' }
    ],
    name: 'setGasCalculator',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function'
  },
  {
    inputs: [
      { internalType: 'address', name: 'newMinterAddress', type: 'address' }
    ],
